"""Diálogo do detector de duplicados (item 47) — nunca apaga automaticamente."""
...
from sfx_app.services.duplicate_service import DuplicateGroup
...
class DuplicatesDialog(QDialog):
    ...
    def __init__(self, groups: list[DuplicateGroup], parent=None):
        ...
        self.tree.setHeaderLabels(["Efeito", "Categoria", "Duração", "Tamanho"])
        ...
        if possible:
            self._add_section("POSSÍVEL DUPLICADO", possible, "#e0a458")
        if not groups:
