...
echo ============================================================
echo   RPG Soundtrack Manager - Instalacao
echo ============================================================
echo.
...
if errorlevel 1 (
    ...
    echo Isso NAO impede o programa de abrir, escanear ou tocar musicas.
    echo Ele so e necessario se voce usar a opcao "Converter tudo para MP3"
    echo ao exportar uma soundtrack.
